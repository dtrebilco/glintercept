...
void glAlphaFunc( GLenum[Main] func, GLfloat ref );
...
void glPixelMapfv( GLenum[Main] map, GLsizei mapsize, const GLfloat *values );
void glPixelMapuiv( GLenum[Main] map, GLsizei mapsize, const GLuint *values );
void glPixelMapusv( GLenum[Main] map, GLsizei mapsize, const GLushort *values );
