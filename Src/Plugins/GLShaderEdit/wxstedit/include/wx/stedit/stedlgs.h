...
// Maintainer:
// Created:     2003-04-28
// RCS-ID:      $Id: stedlgs.h,v 1.20 2006/04/06 04:43:07 jrl1 Exp $
...
public:
    ...
    wxSTEditorPrefDialog( const wxSTEditorPrefPageData& editorPrefData,
                          ...
                          const wxString& title = _T("Editor Preferences"),
...
public:
    wxSTEditorInsertTextDialog(wxWindow* parent,
                               const wxString& title = wxT("Insert Text"),
                               long style = wxDEFAULT_DIALOG_STYLE);
...
public:
    wxSTEditorColumnizeDialog(wxWindow* parent,
                              const wxString& title = wxT("Columnize Text"),
                              long style = wxDEFAULT_DIALOG_STYLE|
