...
enum STEFindReplaceFlags
{
    ...
    STE_FR_WHOLEDOC      = 0x100, // search the whole doc starting from top
    STE_FR_FROMCURSOR    = 0x200, // search starting at cursor
    STE_FR_ALLDOCS       = 0x400, // for notebook, starts at current page and goes forward
...
public:
    ...
    //wxArrayString *GetSearchDirs() { return &m_searchDirs; }
...
public:
    ...
    const wxSTEditorFindReplaceData *GetData() const { return m_findReplaceData; }
