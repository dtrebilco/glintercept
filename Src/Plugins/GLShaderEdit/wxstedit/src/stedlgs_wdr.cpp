...
wxSizer *wxSTEditorFindReplaceSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxCheckBox *item15 = new wxCheckBox( parent, ID_STEDLG_WHOLEWORD_CHECKBOX, _("&Whole word"), wxDefaultPosition, wxDefaultSize, 0 );
    item15->SetToolTip( _("Find string must be a whole word") );
    item14->Add( item15, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    wxCheckBox *item16 = new wxCheckBox( parent, ID_STEDLG_MATCHCASE_CHECKBOX, _("Match &case"), wxDefaultPosition, wxDefaultSize, 0 );
    item16->SetToolTip( _("Ignore the case when finding the string") );
    item14->Add( item16, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    wxCheckBox *item17 = new wxCheckBox( parent, ID_STEDLG_WORDSTART_CHECKBOX, _("Word &start"), wxDefaultPosition, wxDefaultSize, 0 );
    item17->SetToolTip( _("Find string if it's the start of a word") );
    item14->Add( item17, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    item13->Add( item14, 0, wxGROW|wxALIGN_CENTER_HORIZONTAL, 5 );

    wxBoxSizer *item18 = new wxBoxSizer( wxVERTICAL );

    wxCheckBox *item19 = new wxCheckBox( parent, ID_STEDLG_BACKWARDS_CHECKBOX, _("&Backwards"), wxDefaultPosition, wxDefaultSize, 0 );
    item19->SetToolTip( _("Search from the bottom to the top of the document") );
    item18->Add( item19, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    wxCheckBox *item20 = new wxCheckBox( parent, ID_STEDLG_WRAP_CHECKBOX, _("Wra&p around"), wxDefaultPosition, wxDefaultSize, 0 );
    item20->SetToolTip( _("Wrap search to continue searching at the top") );
    item18->Add( item20, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    wxCheckBox *item21 = new wxCheckBox( parent, ID_STEDLG_REGEXP_FIND_CHECKBOX, _("Rege&xpr find"), wxDefaultPosition, wxDefaultSize, 0 );
    item21->SetToolTip( _("Use a regular expression to search for a string") );
    item18->Add( item21, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP, 5 );

    item13->Add( item18, 0, wxGROW|wxALIGN_CENTER_HORIZONTAL, 5 );
    ...
    item22->Add( item25, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxBOTTOM, 5 );
    ...
    item22->Add( item26, 0, wxGROW|wxALIGN_CENTER_VERTICAL, 5 );

    item10->Add( item22, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5 );
...
wxSizer *wxSTEditorInsertTextSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    item15->Add( 10, 10, 0, wxALIGN_CENTER, 5 );
...
wxSizer *wxSTEditorColumnizeSizer( wxWindow *parent, bool call_fit, bool set_sizer )
{
    ...
    wxWindow *item11 = parent->FindWindow( ID_STEDLG_COLUMNIZE_EDITOR );
    wxASSERT( item11 );
