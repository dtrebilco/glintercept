...
// Maintainer:
// Created:     2003-04-04
// RCS-ID:      $Id: stelangs.cpp,v 1.20 2006/03/28 01:04:41 jrl1 Exp $
// Copyright:   (c) John Labenski, Otto Wyss
// Licence:     wxWidgets licence
///////////////////////////////////////////////////////////////////////////////

#if defined(__GNUG__) && !defined(NO_GCC_PRAGMA)
    #pragma implementation "stelangs.h"
#endif
...
//----------------------------------------------------------------------------
// This has been updated to SciTE 1.66, 8/27/05
//
...
//
// Note: we don't need wxChar here since they don't get translated nor are wide
//
// Implementation note:
...
static const char* STE_WordList1_STE_LANG_GLSL =
  "attribute "\
  "break "\
  "const continue "\
  "discard do "\
...
static const char* STE_WordList2_STE_LANG_GLSL = 
...
static const char* STE_WordList3_STE_LANG_GLSL = "";

static const char* STE_WordList4_STE_LANG_GLSL =
  "abs "\
  "acos "\
  "all "\
  "any "\
...
static const char* STE_WordList1_STE_LANG_GLASM =
  "ALIAS OPTION ATTRIB PARAM "\
  "END "\
  "1D 2D 3D CUBE RECT "\
  "TEMP ADDRESS OUTPUT "\
  "ABS ABS_SAT "\
  ...
  "TXB TXB_SAT "\
  "ARL LIT LOG POW "\
  "EQ0 GE0 GT0 LE0 LT0 NE0 TR0 FL0 "\
  "EQ1 GE1 GT1 LE1 LT1 NE1 TR1 FL1 "\
  "PUSHA POPA "\
  "TEX TXP TXB TXL "\
  "RCC ABSC FLR FLRC FRC FRCC LITC MOVC SSG SSGC "\
  "ARLC ARR ARRC "\
  "COS COSC EX2 EX2C LG2 LG2C EXPC LOGC RCCC "\
  "RCPC RSQC SIN SINC "\
  "ADDC DP3C DP4C DPHC DSTC MAXC MINC MULC "\
  "SEQ SEQC SFL SFLC SGEC SGT SGTC SLTC "\
  "SLE SLEC SNE SNEC STR STRC SUBC "\
  "MADC BRA CAL RET ARA ARAC "\
  "DDX DDX_SAT "\
  "DDXR DDXR_SAT "\
  "DDXH DDXH_SAT "\
  "DDXC DDXC_SAT "\
  ...
  "ENDLOOP "\
  "ENDREP "\
  "state material light ambient diffuse specular emission shininess "\
  "position attenuation spot half direction lightmodel "\
  "matrix inverse transpose invtrans "\
  "scenecolor lightprod texenv color fog params "\
  "depth range row "\
  "modelview projection mvp texture palette program "\
  "env local facing "\
  "front back primary secondary "\
  "fragment texcoord fogcoord position "\
  "vertex weight normal fogcoord texcoord "\
  "matrixindex attrib texgen eye clip point size result pointsize "\
  "OPOS WGHT NRML COL0 COL1 FOGC HPOS COL0 "\
  "COL1 BFC0 BFC1 FOGC PSIZ "\
  "CLP0 CLP1 CLP2 CLP3 CLP4 CLP5 "\
  "EQ GE GT LE LT NE TR FL "\
  "COLR COLH DEPR WPOS DEFINE "\
  "TEX0    TEX1    TEX2    TEX3 "\
  "TEX4    TEX5    TEX6    TEX7 "\
...
static const char* STE_WordList2_STE_LANG_HTML =
...
static const char* STE_WordList2_STE_LANG_LUA =
       ...
       "_G getfenv getmetatable ipairs loadlib next pairs pcall rawegal rawget "
...
static const char* STE_WordList3_STE_LANG_LUA =
       ...
       "math.min math.mod math.pi math.rad math.random math.randomseed "
...
static const char* STE_WordList1_STE_LANG_ASP =
       ...
       "strike strong style sub sup table tbody td textarea tfoot th "
       "thead title tr tt u ul var xml xmlns";
static const char* STE_WordList2_STE_LANG_ASP =
       "abbr accept-charset accept accesskey action align alink alt "
       "archive axis background bgcolor border cellpadding cellspacing "
       "char charoff charset checked cite class classid clear codebase "
       "codetype color cols colspan compact content coords data datafld "
...
static const char* STE_WordList1_STE_LANG_PHP =
       ...
       "strike strong style sub sup table tbody td textarea tfoot th "
       "thead title tr tt u ul var xml xmlns";
static const char* STE_WordList2_STE_LANG_PHP =
       "abbr accept-charset accept accesskey action align alink alt "
       "archive axis background bgcolor border cellpadding cellspacing "
       "char charoff charset checked cite class classid clear codebase "
       "codetype color cols colspan compact content coords data datafld "
...
#define STE_LexerWords_STE_LANG_GLSL_COUNT 4
#define DefSTE_LexerWords_STE_LANG_GLSL \
    STE_LexerWords STE_LexerWords_STE_LANG_GLSL[]       = { { 1, STE_WordList1_STE_LANG_GLSL }, \
                                                            { 1, STE_WordList2_STE_LANG_GLSL }, \
                                                            { 1, STE_WordList3_STE_LANG_GLSL }, \
                                                            { 1, STE_WordList4_STE_LANG_GLSL } };
#define STE_LexerWords_STE_LANG_GLASM_COUNT 1
#define DefSTE_LexerWords_STE_LANG_GLASM \
    STE_LexerWords STE_LexerWords_STE_LANG_GLASM[]      = { { 1, STE_WordList1_STE_LANG_GLASM } };


#endif //GLI_CHANGES

#define STE_LexerWords_STE_LANG_HTML_COUNT 2
#define DefSTE_LexerWords_STE_LANG_HTML \
    STE_LexerWords STE_LexerWords_STE_LANG_HTML[]       = { { 1, STE_WordList1_STE_LANG_HTML }, \
                                                            { 1, STE_WordList2_STE_LANG_HTML } };
...
#define STE_LexerWords_STE_LANG_ASP_COUNT 2
#define DefSTE_LexerWords_STE_LANG_ASP \
    STE_LexerWords STE_LexerWords_STE_LANG_ASP[]        = { { 1, STE_WordList1_STE_LANG_ASP }, \
                                                            { 1, STE_WordList2_STE_LANG_ASP } };

#define STE_LexerWords_STE_LANG_PHP_COUNT 2
#define DefSTE_LexerWords_STE_LANG_PHP \
    STE_LexerWords STE_LexerWords_STE_LANG_PHP[]        = { { 1, STE_WordList1_STE_LANG_PHP }, \
                                                            { 1, STE_WordList2_STE_LANG_PHP } };
...
#define STE_LexerName_STE_LANG_CLIKE_     "CLIKE UNKNOWN"
#define STE_LexerName_STE_LANG_HYPERTEXT_ "HYPER UNKNOWN"
#define STE_LexerName_STE_LANG_MAKE_      "MAKE UNKNOWN"
#define STE_LexerName_STE_LANG_CAML_      "CAML UNKNOWN"
#define STE_LexerName_STE_LANG_VERILO_    "VERILO UNKNOWN"
#define STE_LexerName_STE_LANG_ERLAN_     "ERNAN UNKNOWN"
#define STE_LexerName_STE_LANG_CONTEXT_   "CONTEXT UNKNOWN"

#ifdef GLI_CHANGES

#define STE_LexerName_STE_LANG_GLSL       "GLSL"
#define STE_LexerName_STE_LANG_GLASM      "GL asm"
...
#define STE_LexerLang_STE_LANG_CLIKE_     wxSTC_LEX_CPP
#define STE_LexerLang_STE_LANG_HYPERTEXT_ wxSTC_LEX_HTML
#define STE_LexerLang_STE_LANG_MAKE_      wxSTC_LEX_MAKEFILE
#define STE_LexerLang_STE_LANG_CAML_      wxSTC_LEX_MAKEFILE
#define STE_LexerLang_STE_LANG_VERILO_    wxSTC_LEX_MAKEFILE
#define STE_LexerLang_STE_LANG_ERLAN_     wxSTC_LEX_MAKEFILE
#define STE_LexerLang_STE_LANG_CONTEXT_   wxSTC_LEX_MAKEFILE


#ifdef GLI_CHANGES

#define STE_LexerLang_STE_LANG_GLSL       wxSTC_LEX_CPP
#define STE_LexerLang_STE_LANG_GLASM      wxSTC_LEX_PYTHON
...
#define STE_LexerFolds_STE_LANG_CLIKE_     0
#define STE_LexerFolds_STE_LANG_HYPERTEXT_ 0
#define STE_LexerFolds_STE_LANG_MAKE_      0
#define STE_LexerFolds_STE_LANG_CAML_      0
#define STE_LexerFolds_STE_LANG_VERILO_    0
#define STE_LexerFolds_STE_LANG_ERLAN_     0
#define STE_LexerFolds_STE_LANG_CONTEXT_   0


#ifdef GLI_CHANGES

#define STE_LexerFolds_STE_LANG_GLSL       0
#define STE_LexerFolds_STE_LANG_GLASM      0
...
#define STE_LexerFlags_STE_LANG_CLIKE_     0
#define STE_LexerFlags_STE_LANG_HYPERTEXT_ 0
#define STE_LexerFlags_STE_LANG_MAKE_      0
#define STE_LexerFlags_STE_LANG_CAML_      0
#define STE_LexerFlags_STE_LANG_VERILO_    0
#define STE_LexerFlags_STE_LANG_ERLAN_     0
#define STE_LexerFlags_STE_LANG_CONTEXT_   0


#ifdef GLI_CHANGES

#define STE_LexerFlags_STE_LANG_GLSL       0
#define STE_LexerFlags_STE_LANG_GLASM      0
...
#define STE_LexerFilters_STE_LANG_CLIKE_     ""
#define STE_LexerFilters_STE_LANG_HYPERTEXT_ ""
#define STE_LexerFilters_STE_LANG_MAKE_      ""
#define STE_LexerFilters_STE_LANG_CAML_      "Objective Caml (ml mli)|*.ml;*.mli|"
#define STE_LexerFilters_STE_LANG_VERILO_    "Verilog (verilog)| MISSING:file.patterns.verilog |"
#define STE_LexerFilters_STE_LANG_ERLAN_     "Erlang (erl)| MISSING:file.patterns.erlang |"
#define STE_LexerFilters_STE_LANG_CONTEXT_   "ConTeXt|*.tex;*.tui;*.tuo;*.sty;|"

#ifdef GLI_CHANGES

#define STE_LexerFilters_STE_LANG_GLSL       "GLSL (glsl)|*.glsl|"
#define STE_LexerFilters_STE_LANG_GLASM      "GLASM (glasm)|*.arbfp|*.arbvp|*.nvfp|*.nvvp|"
...
#define STE_LexerFilePatterns_STE_LANG_HTML       "*.html;*.htm;*.asp;*.shtml;*.htd;*.php3;*.phtml;*.php;*.htt;*.cfm;*.tpl;*.dtd;*.hta"
...
#define STE_LexerFilePatterns_STE_LANG_CLIKE_     "*.c;*.cc;*.cpp;*.cxx;*.cs;*.h;*.hh;*.hpp;*.hxx;*.sma;*.cs;*.idl;*.odl;*.java;*.as;*.asc;*.jsfl;*.ch;*.chf;*.chs"
#define STE_LexerFilePatterns_STE_LANG_HYPERTEXT_ ""
#define STE_LexerFilePatterns_STE_LANG_MAKE_      "makefile;Makefile;*.mak;configure*"
#define STE_LexerFilePatterns_STE_LANG_CAML_      "*.ml;*.mli"
#define STE_LexerFilePatterns_STE_LANG_VERILO_    "*.v;*.vh"
#define STE_LexerFilePatterns_STE_LANG_ERLAN_     "*.erl"
#define STE_LexerFilePatterns_STE_LANG_CONTEXT_   "*.tex;*.tui;*.tuo;*.sty;"


#ifdef GLI_CHANGES

#define STE_LexerFilePatterns_STE_LANG_GLSL       "*.glsl"
#define STE_LexerFilePatterns_STE_LANG_GLASM      "*.arbfp;*.arbvp;*.nvfp;*.nvvp"
...
#define STE_LexerBraces_STE_LANG_CLIKE_     0
#define STE_LexerBraces_STE_LANG_HYPERTEXT_ 0
#define STE_LexerBraces_STE_LANG_MAKE_      0
#define STE_LexerBraces_STE_LANG_CAML_      6
#define STE_LexerBraces_STE_LANG_VERILO_    0
#define STE_LexerBraces_STE_LANG_ERLAN_     0
#define STE_LexerBraces_STE_LANG_CONTEXT_   0

#ifdef GLI_CHANGES

#define STE_LexerBraces_STE_LANG_GLSL       10
#define STE_LexerBraces_STE_LANG_GLASM      10
...
#define DefSTE_LexerComments_STE_LANG_CLIKE_
#define DefSTE_LexerComments_STE_LANG_HYPERTEXT_ STE_LexerComments _STE_LexerComments_STE_LANG_HYPERTEXT_ = { 0, "", "", "", "", "<!--", "-->" };
#define DefSTE_LexerComments_STE_LANG_MAKE_
#define DefSTE_LexerComments_STE_LANG_CAML_      STE_LexerComments _STE_LexerComments_STE_LANG_CAML_      = { 0, "", "(*", "*", "*)", "(*", "*)" };
#define DefSTE_LexerComments_STE_LANG_VERILO_    STE_LexerComments _STE_LexerComments_STE_LANG_VERILO_    = { 0, "//", "/*", "*", "*/", "/*", "*/" };
#define DefSTE_LexerComments_STE_LANG_ERLAN_     STE_LexerComments _STE_LexerComments_STE_LANG_ERLAN_     = { 0, "%", "", "", "", "", "" };
#define DefSTE_LexerComments_STE_LANG_CONTEXT_


#ifdef GLI_CHANGES

#define DefSTE_LexerComments_STE_LANG_GLSL       
#define DefSTE_LexerComments_STE_LANG_GLASM      
...
#define STE_LexerComments_STE_LANG_CLIKE_     NULL
#define STE_LexerComments_STE_LANG_HYPERTEXT_ &_STE_LexerComments_STE_LANG_HYPERTEXT_
#define STE_LexerComments_STE_LANG_MAKE_      NULL
#define STE_LexerComments_STE_LANG_CAML_      &_STE_LexerComments_STE_LANG_CAML_
#define STE_LexerComments_STE_LANG_VERILO_    &_STE_LexerComments_STE_LANG_VERILO_
#define STE_LexerComments_STE_LANG_ERLAN_     &_STE_LexerComments_STE_LANG_ERLAN_
#define STE_LexerComments_STE_LANG_CONTEXT_   NULL

#ifdef GLI_CHANGES

#define STE_LexerComments_STE_LANG_GLSL       &_STE_LexerComments_STE_LANG_CPP
#define STE_LexerComments_STE_LANG_GLASM      &_STE_LexerComments_STE_LANG_PYTHON
...
#define DefSTE_LexerBlock_STE_LANG_CLIKE_     STE_LexerBlock _STE_LexerBlock_STE_LANG_CLIKE_     = { 10, "{", 10, "}" };
#define DefSTE_LexerBlock_STE_LANG_HYPERTEXT_
#define DefSTE_LexerBlock_STE_LANG_MAKE_
#define DefSTE_LexerBlock_STE_LANG_CAML_
#define DefSTE_LexerBlock_STE_LANG_VERILO_
#define DefSTE_LexerBlock_STE_LANG_ERLAN_
#define DefSTE_LexerBlock_STE_LANG_CONTEXT_

#ifdef GLI_CHANGES

#define DefSTE_LexerBlock_STE_LANG_GLSL
#define DefSTE_LexerBlock_STE_LANG_GLASM
...
#define STE_LexerBlock_STE_LANG_CLIKE_     &_STE_LexerBlock_STE_LANG_CLIKE_
#define STE_LexerBlock_STE_LANG_HYPERTEXT_ NULL
#define STE_LexerBlock_STE_LANG_MAKE_      NULL
#define STE_LexerBlock_STE_LANG_CAML_      NULL
#define STE_LexerBlock_STE_LANG_VERILO_    NULL
#define STE_LexerBlock_STE_LANG_ERLAN_     NULL
#define STE_LexerBlock_STE_LANG_CONTEXT_   NULL


#ifdef GLI_CHANGES

#define STE_LexerBlock_STE_LANG_GLSL       &_STE_LexerBlock_STE_LANG_CPP
#define STE_LexerBlock_STE_LANG_GLASM      NULL
...
#define DefSTE_LexerPreproc_STE_LANG_CLIKE_
#define DefSTE_LexerPreproc_STE_LANG_HYPERTEXT_
#define DefSTE_LexerPreproc_STE_LANG_MAKE_      STE_LexerPreproc _STE_LexerPreproc_STE_LANG_MAKE       = { "!", "IF IFDEF IFNDEF", "ELSE ELSEIF ELSEIFDEF ELSEIFNDEF", "ENDIF" };
#define DefSTE_LexerPreproc_STE_LANG_CAML_
#define DefSTE_LexerPreproc_STE_LANG_VERILO_
#define DefSTE_LexerPreproc_STE_LANG_ERLAN_
#define DefSTE_LexerPreproc_STE_LANG_CONTEXT_

#ifdef GLI_CHANGES

#define DefSTE_LexerPreproc_STE_LANG_GLSL
#define DefSTE_LexerPreproc_STE_LANG_GLASM
...
#define STE_LexerPreproc_STE_LANG_CLIKE_     NULL
#define STE_LexerPreproc_STE_LANG_HYPERTEXT_ NULL
#define STE_LexerPreproc_STE_LANG_MAKE_      &_STE_LexerPreproc_STE_LANG_MAKE
#define STE_LexerPreproc_STE_LANG_CAML_      NULL
#define STE_LexerPreproc_STE_LANG_VERILO_    NULL
#define STE_LexerPreproc_STE_LANG_ERLAN_     NULL
#define STE_LexerPreproc_STE_LANG_CONTEXT_   NULL

#ifdef GLI_CHANGES

#define STE_LexerPreproc_STE_LANG_GLSL       &_STE_LexerPreproc_STE_LANG_CPP
#define STE_LexerPreproc_STE_LANG_GLASM      NULL
...
#define STE_LexerStyles_STE_LANG_PYTHON_COUNT 14
...
#define STE_LexerStyles_STE_LANG_GLSL_COUNT STE_LexerStyles_STE_LANG_CPP_COUNT
STE_LexerStyles* STE_LexerStyles_STE_LANG_GLSL = STE_LexerStyles_STE_LANG_CPP;

#define STE_LexerStyles_STE_LANG_GLASM_COUNT STE_LexerStyles_STE_LANG_PYTHON_COUNT
STE_LexerStyles* STE_LexerStyles_STE_LANG_GLASM = STE_LexerStyles_STE_LANG_PYTHON;
...
#endif
/*
#if STE_USE_LANG_CLIKE_
    DEFINE_STE_LANG(STE_LANG_CLIKE_    )
    #define STE_Lang_STE_LANG_CLIKE_     &_STE_Lang_STE_LANG_CLIKE_
#else
    #define STE_Lang_STE_LANG_CLIKE_     NULL
#endif
#if STE_USE_LANG_HYPERTEXT_
    DEFINE_STE_LANG(STE_LANG_HYPERTEXT_)
    #define STE_Lang_STE_LANG_HYPERTEXT_ &_STE_Lang_STE_LANG_HYPERTEXT_
#else
    #define STE_Lang_STE_LANG_HYPERTEXT_ NULL
#endif
#if STE_USE_LANG_MAKE_
    DEFINE_STE_LANG(STE_LANG_MAKE_     )
    #define STE_Lang_STE_LANG_MAKE_      &_STE_Lang_STE_LANG_MAKE_
#else
    #define STE_Lang_STE_LANG_MAKE_      NULL
#endif
#if STE_USE_LANG_CAML_
    DEFINE_STE_LANG(STE_LANG_CAML_     )
    #define STE_Lang_STE_LANG_CAML_      &_STE_Lang_STE_LANG_CAML_
#else
    #define STE_Lang_STE_LANG_CAML_      NULL
#endif
#if STE_USE_LANG_VERILO_
    DEFINE_STE_LANG(STE_LANG_VERILO_   )
    #define STE_Lang_STE_LANG_VERILO_    &_STE_Lang_STE_LANG_VERILO_
#else
    #define STE_Lang_STE_LANG_VERILO_    NULL
#endif
#if STE_USE_LANG_ERLAN_
    DEFINE_STE_LANG(STE_LANG_ERLAN_    )
    #define STE_Lang_STE_LANG_ERLAN_     &_STE_Lang_STE_LANG_ERLAN_
#else
    #define STE_Lang_STE_LANG_ERLAN_     NULL
#endif
#if STE_USE_LANG_CONTEXT_
    DEFINE_STE_LANG(STE_LANG_CONTEXT_  )
    #define STE_Lang_STE_LANG_CONTEXT_   &_STE_Lang_STE_LANG_CONTEXT_
#else
    #define STE_Lang_STE_LANG_CONTEXT_   NULL
#endif
*/

#ifdef GLI_CHANGES

    DEFINE_STE_LANG(STE_LANG_GLSL      )
    #define STE_Lang_STE_LANG_GLSL        &_STE_Lang_STE_LANG_GLSL

    DEFINE_STE_LANG(STE_LANG_GLASM    )
    #define STE_Lang_STE_LANG_GLASM     &_STE_Lang_STE_LANG_GLASM
...
/*
    STE_Lang_STE_LANG_CLIKE_    ,
    STE_Lang_STE_LANG_HYPERTEXT_,
    STE_Lang_STE_LANG_MAKE_     ,
    STE_Lang_STE_LANG_CAML_     ,
    STE_Lang_STE_LANG_VERILO_   ,
    STE_Lang_STE_LANG_ERLAN_    ,
    STE_Lang_STE_LANG_CONTEXT_  ,
*/

#ifdef GLI_CHANGES

    STE_Lang_STE_LANG_GLSL      ,
    STE_Lang_STE_LANG_GLASM     ,
...
{
public:
    IntString(int key = 0, const wxString& value = wxEmptyString) : m_int(key), m_value(value) {}
    IntString& Set(int key, const wxString& value = wxEmptyString) { m_int=key; m_value=value; return *this; }
    int m_int;
    wxString m_value;
};
int wxCMPFUNC_CONV IntStringSort(IntString* pItem1, IntString* pItem2)
{
    return pItem1->m_int - pItem2->m_int;
}

WX_DEFINE_SORTED_ARRAY(IntString*, wxSortedArrayIntString);
#include <stdlib.h>



#define DECLARE_SORTED_KEYVALUE_ARRAY_BASE(Tkey, Tval, Tclass, name, classexp) \
\
typedef int wxCMPFUNC_CONV (* Tclass##Cmp )(Tclass *, Tclass *); \
\
WX_DEFINE_SORTED_ARRAY(Tclass *, name##Base); \
\
classexp name : public name##Base \
{         \
public:   \
    name( Tclass##Cmp fn = NULL) : name##Base(fn) {} \
};

DECLARE_SORTED_KEYVALUE_ARRAY_BASE(int, wxString, IntString, IntStringSortedArray, class);



void TestPairArray()
{
    int n, count = 1000000, num = 0;
    wxString s;

    wxStartTimer();

    {
    PsuedoRandom rnd(0, 10000000);
    wxSTEPairArrayIntString pairs;

    for (n=0; n < count; n++)
    {
        pairs.Add(rnd.Get(), wxT(""));
    }

    wxPrintf(wxT("Time %d\n"), wxGetElapsedTime(true));

    for (n=0; n < count; n++)
        pairs.FindIndex(rnd.Get());

    wxPrintf(wxT("TimeF %d\n"), wxGetElapsedTime(true));
    ...
    {
    PsuedoRandom rnd(0, 10000000);
    wxSortedArrayIntString sorted(IntStringSort);
    IntString is;
    int index = 0;
    ...
    {
        int v = rnd.Get();
        index = sorted.Index(&is.Set(v));
        if (index == wxNOT_FOUND)
            sorted.Add(new IntString(v, wxT("")));
        else
            sorted[index]->Set(v, wxT(""));
    ...
    num = sorted.GetCount();
    for (n=0; n < num; n++)
        s = sorted.Item(n)->m_value;

    wxPrintf(wxT("TimeF %d\n"), wxGetElapsedTime(true));

    for (n=0; n < num; n++)
    {
        IntString *is = sorted[0];
        sorted.RemoveAt(0);
        delete is;
    }
