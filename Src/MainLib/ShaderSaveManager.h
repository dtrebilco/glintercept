...
=============================================================================*/
#ifndef __SHADER_SAVE_MANAGER_H_
#define __SHADER_SAVE_MANAGER_H_
...
public:
  ...
  //
  ShaderSaveManager(const ConfigData &configData);

  //@
  //  Summary:
  //    Destructor
  //  
  virtual ~ShaderSaveManager();
  ...
  //
  bool SaveShader(const string &fileName, const ShaderData *shaderData,string &retFileName) const;
...
protected:
  ...
  //@
  //  Summary:
  //    To save a specific shader type to disk. (formatting if necessary)
  //  
  //  Parameters:
  //    fileName  - The base file name to save the shader out as. (without extension)
  //
  ...
  //    Otherwise false is returned.
  //
  bool SaveARBShader(const string &fileName, const ShaderData *shaderData,string &retFileName) const;
  bool SaveNVShader(const string &fileName, const ShaderData *shaderData,string &retFileName) const;
...
#endif // __SHADER_SAVE_MANAGER_H_
